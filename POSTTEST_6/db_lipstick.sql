...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Apr 2026 pada 16.19
...
INSERT INTO `tb_review` (`id_review`, `id_produk`, `nama_reviewer`, `rating`, `komentar`, `tgl_review`) VALUES
(1, 1, 'Siska Amelia', 5, 'Warnanya cantik banget dan tahan lama seharian!', '2026-04-20'),
(2, 2, 'Lani Wijaya', 3, 'Warna nude-nya pas, tapi pengirimannya agak lama.', '2026-04-16'),
(3, 3, 'Putri Rahma', 5, 'Suka banget efek glossy-nya!', '2026-04-18');
...
ALTER TABLE `tb_review`
  ...
  ADD KEY `fk_produk_review` (`id_produk`);
...
--
ALTER TABLE `tb_review`
  ADD CONSTRAINT `fk_produk_review` FOREIGN KEY (`id_produk`) REFERENCES `tb_produk` (`id_produk`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
